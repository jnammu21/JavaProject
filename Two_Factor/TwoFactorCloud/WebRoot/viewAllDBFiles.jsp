...
<tr bgcolor="#50cccc">
				...
				<td width="233" height="16">
					...
					<c:forEach var="vcb" items="${vcb}">
                     ...
                     System.out.println(" FILEid value is ~~~~~~~~~~"+fileid);
                        
                        %>
                       <tr bgcolor="#CcC9cA">
						<td bgcolor="#C3D7BA">
								<div align="center">
		<span class="style7"><INPUT TYPE="RADIO" NAME="fileid" VALUE="${vcb.fileid}" CHECKED/></span>
								</div>
							</td>
...
<CENTER>
			...
			<CENTER><input type=submit value="SEND TO CLOUD SERVER"/>
		</CENTER></form>
